import { Rocket, Github, LayoutDashboard, MessageSquare, Moon, Sun } from 'lucide-react';
...
export const Navbar = () => {
  ...
  const navLinks = [
    { href: "/", label: "Home", icon: <Rocket className="h-4 w-4 sm:h-5 sm:w-5 md:hidden" /> },
        ...
        <div className="flex h-10 sm:h-12 items-center justify-between rounded-full border border-border/40 bg-background/95 px-2 sm:px-4 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-lg">
          <div className="flex items-center">
            <a href="/" className="flex items-center space-x-1 sm:space-x-2 group">
              <Rocket className="h-4 w-4 sm:h-5 sm:w-5 text-primary transition-transform duration-300 group-hover:scale-110" />
